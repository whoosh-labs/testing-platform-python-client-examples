...
def replace_url(old_value):
    url = f"https://satsure-raga-testing-platform-backend-s3-storage.s3.ap-south-1.amazonaws.com/Satellite_Image_dataset/{old_value.replace('./', '')}"
...
# test_session = TestSession(project_name="Semantic Segmentation", run_name= run_name, access_key="DlGhu2Y9D7Kbc955Y0tz", secret_key="euSZgU49jkIV4CTekcKvpqdk93sQpZdRe338ym1N", host="http://13.126.220.245:8080")
