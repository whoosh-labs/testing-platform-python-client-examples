...
def gt_mask_url(x):
    tif = x.split("/")[1]
    return f"https://raga-testing-storage.s3.ap-south-1.amazonaws.com/1/semantic_segmentation_demo_label_old/{tif}"
...
data_frame = csv_parser("./assets/failure_mode_analysis_60%.csv")
...
test_session = TestSession(project_name="Semantic Segmentation", run_name = run_name, profile="honywell")

cred = DatasetCreds(region="ap-south-1")

#create test_ds object of Dataset instance
test_ds = Dataset(test_session=test_session, 
                  name="failure_mode_analysis_sementic_v1", 
