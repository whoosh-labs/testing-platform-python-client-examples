...
pd_data_frame = csv_parser("/Users/rupalitripathi/IdeaProjects/testing-platform-python-client/raga/examples/assets/engg_df_model_emb_final1.csv")
...
schema.add("embedding", ImageEmbeddingSchemaElement(model="yolov8"))
...
test_ds = Dataset(test_session=test_session,
                  name="fma-instance-emb_6feb-v1",
                  type=DATASET_TYPE.IMAGE,
                  data=pd_data_frame,
                  schema=schema,
                  creds=cred)

test_ds.raga_extracted_dataset.to_csv("embed_instance.csv", index = False)
