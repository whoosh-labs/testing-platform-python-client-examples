...
data_frame = csv_parser("https://ragatesitng-dev-storage.s3.ap-south-1.amazonaws.com/datasets/policy_bazaar/ragaAI_test_policy_bazaar.csv")

########
## OR ##
########

# data_frame = csv_parser("./ragaAI_test_policy_bazaar.csv")
...
test_ds = Dataset(test_session=test_session,
                  name="policy_bazaar_test_dataset",
