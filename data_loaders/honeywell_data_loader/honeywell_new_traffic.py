...
pd_data_frame = csv_parser("https://ragatesitng-dev-storage.s3.ap-south-1.amazonaws.com/datasets/honeywell/new_traffic.csv")

########
## OR ##
########

# pd_data_frame = csv_parser("./assets/new_traffic.csv")
...
test_ds = Dataset(test_session=test_session,
                  name="drift_honeywell_traffic_pred_object_detection_v1",
