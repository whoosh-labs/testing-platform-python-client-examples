...
schema.add("ImageUriLr", FeatureSchemaElement())
schema.add("hr_embedding", ImageEmbeddingSchemaElement(model="Satsure Embedding Model"))
schema.add("lr_embedding", ImageEmbeddingSchemaElement(model="Satsure Embedding Model"))
...
test_ds = Dataset(test_session=test_session,
                  name="semantic_dataset_20k_no_executor6",
